...
class _RespondedAlertsScreenState extends State<RespondedAlertsScreen> {
  ...
  Future<void> fetchRespondedAlerts() async {
    try {
      ...
      final alertSnapshot = await FirebaseFirestore.instance
          .collection('Alerts')
          .where('responders', arrayContains: currentUserId)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Responded Alerts'),
        backgroundColor: Colors.white,
          ...
          Expanded(
            child: isLoading
              ...
              child: Column(
                ...
                : RefreshIndicator(
              onRefresh: fetchRespondedAlerts,
              color: Colors.red,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailRow('From', alert.userName),
                const SizedBox(height: 8),
...
// }
//
// class _RespondedAlertsScreenState extends State<RespondedAlertsScreen> with TickerProviderStateMixin {
//   List<AlertModel> alerts = [];
//   bool isLoading = true;
//   Map<String, String> cachedAddresses = {};
...
//                 _buildStatDivider(),
//                 _buildStatItem('Active', '$dangerCount', Icons.warning_outlined, const Color(0xFFEF4444)),
//               ],
//             ),
//             const SizedBox(height: 20),
//             Row(
//               children: [
//                 _buildStatItem('Resolved', '$safeCount', Icons.check_circle_outline, const Color(0xFF10B981)),
//                 _buildStatDivider(),
...
//                     boxShadow: [
//                       BoxShadow(
//                         color: getStatusColor(alert.status).withOpacity(0.3),
//                         blurRadius: 8,
//                         spreadRadius: 2,
//                       ),
//                     ],
...
//                           end: Alignment.bottomCenter,
//                           colors: [
//                             getStatusColor(alert.status).withOpacity(0.3),
...
//                     _buildDetailSection(
//                       'Responders',
//                       '${alert.responders!.length} people responded',
